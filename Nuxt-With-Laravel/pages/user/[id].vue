                ...
                <div v-else>
                    <form @submit.prevent="saveUpdate">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" v-model="user.password" class="form-control" disabled>
                            <span class="text-danger" v-if="errorList.password">{{ errorList.password[0] }}</span>
                        </div>
                        <div class="mb-3">
                            <label>Confirm Password</label>
                            <input type="password" v-model="user.confirm_password" class="form-control" disabled>
...
export default {
    ...
    methods: {
        ...
        saveUpdate() {
            ...
            axios.post(`http://localhost:8000/api/user/${this.userId}/update`, formData, {
                headers: {
